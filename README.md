...
* ![logo](http://chakra-linux.org/img/icon/chakra-kde_32.png "chakra logo")Chakra Linux via CCR Package: http://chakra-linux.org/ccr/packages.php?ID=3388
...
* ![logo](http://www.monitorix.org/imgs/debian.png "debian logo")Debian/Ubuntu via user created deb: http://link.coming.soon
* ![logo](http://www.monitorix.org/imgs/ubuntu.png "ubuntu logo")Debian/Ubuntu via user created deb: http://link.coming.soon
